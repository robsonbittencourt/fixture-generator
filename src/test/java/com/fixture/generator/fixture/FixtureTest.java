...
import com.fixture.generator.clazz.part.AbstractGeneratedClass;
...
public class FixtureTest {
	...
	public void shouldReturnThePathWithOriginClassPackageNameWhenDoNotHavePackageNameInConfiguration() {
		assertEquals("src/test/java/com/fixture/generator/base/clazz", generatedClass.classFilePath());
	}
	...
	public void shouldValidateTheGeneratedClass() {
		...
		builder.append("package com.fixture.generator.base.clazz;\n");
		builder.append("\n");
		builder.append("import java.util.List;\n");
		builder.append("import java.util.ArrayList;\n");
		builder.append("import com.fixture.generator.base.clazz.Person;\n");
